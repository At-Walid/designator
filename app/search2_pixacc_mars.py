...
# create website
web_dir = os.path.join('./results/DESIGNATE_pixel/')
...
class GaGan(object):
    ...
    def __init__(self):
        ...
        self.airsim = airsim
        self.dir = "./results/DESIGNATE_pixel/"
    ...
    def control_car_from_csv(self):
        ...
        for row in rows:
            ...
            # Wait until the car is stationary or 5 seconds have passed
...
def find_highest_pixel_accuracy(target_mask_path, archive):
    ...
    highest_accuracy = -1
    highest_accuracy_filename = archive[0]
...
class GanProblem(pymoo.problems.multi.Problem):
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        type_distance = 'PixelAccuracy'
        threshold_diversity = 0.05
        print('@@@@@@@@@@@@', X)
